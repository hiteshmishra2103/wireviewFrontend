...
const PcLoginLogout = () => {
    ...
    if (!isMounted) {
        ...
        return (
            <>
                {user.user ? (
                    <button className={`${styles.btn} ${styles.pcLoginBtn}`} onClick={() => {
                    ...
                    <>
                        <button className={`${styles.btn} ${styles.pcLoginBtn}`} onClick={() => openSigninModal()}>Login</button>
                        <Login />
